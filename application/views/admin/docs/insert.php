		...
		<div class="col-md-12">
			...
			<div class="panel panel-default" data-widget='{"draggable": "false"}'>
				...
				<div class="panel-body">
                  ...
                  <div class="form">
                            <form data-toggle="validator" action="<? echo site_url("admin_docs/insert");?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="register_form">
             <fieldset>
             ...
             <!--  <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text"  min="1" name="title"  id="title" class="form-control" required>
                </div>
              </div>                                  
             ...
             <div class="form-group required">
                  <label class="col-sm-2 control-label" for="pic">檔案</label>
                       <div class="col-md-10">
                       <input id="file-0a" class="file" type="file" multiple data-min-file-count="0" name="pic[]" required>
