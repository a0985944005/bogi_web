		...
		<div class="col-md-12">
			...
			<div class="panel panel-default" data-widget='{"draggable": "false"}'>
				...
				<div class="panel-body">
                  ...
                  <div class="form">
                            <form data-toggle="validator" action="<? echo site_url("admin_item/update");?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="register_form">
             <fieldset>

             <!--  <div class="form-group required">
                <label class="col-sm-2 control-label" for="M_account">#</label>
                <div class="col-sm-10">
                  <?=$item_data['id']?>
                </div>
              </div> -->
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="title" value="<?=$item_data['title']?>" id="title" class="form-control">
                </div>
              </div>
<!-- 
			  <div class="form-group required">
                ...
                <div class="col-sm-10">
                  	<img src = "application/views/front/theme/img/works/<?=$item_data['item_pic'];?>" width="200px" heigh="80px">
                </div>
              </div> -->



                      <? if(!empty($item_data['item_pic']))
                      {
                    ?>
               <div class="form-group required">
                                                ...
                                                <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td data-title="檔案名稱" align="center" style="word-wrap:break-word;">
                                                                   <a href='index.php/admin_item/download_files/<?=$item_data['id'];?>'><img src = "application/views/front/theme/img/works/<?=$item_data['item_pic'];?>" width="200px" heigh="80px"></a>
                                                            </td>
                                                           <!--  <td data-title="動作"  align="center">
                                                             <a  style="margin: 60px auto;" class='btn btn-danger delete' href='index.php/admin_item/delete_files/<?=$item_data['id'];?>' onclick="return confirm('確定刪除?')";>
              ...
              <input type="hidden" name="id" value="<?=$item_data['id']?>">
                <button class="btn btn-primary" type="submit" id="submit_regform" onclick="return(confirm('確認要更改嗎？'))">送出</button>   
                 <a  href="<? echo site_url("admin_item/index/index");?>" class="btn btn-danger" id="submit_regform">返回</a>       
              </div>
            </div>
                  </form>
