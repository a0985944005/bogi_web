		...
		<div class="col-md-12">
			...
			<div class="panel panel-default" data-widget='{"draggable": "false"}'>
				...
				<div class="panel-body">
                  ...
                  <div class="form">
                            <form data-toggle="validator" action="<? echo site_url("admin_faq/insert");?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="register_form">
             <fieldset>
           ...
           <!--   <div class="form-group required">
            ...
            <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <textarea name="answer" rows="5" class="form-control"  id="input-confirm"  required="required"></textarea>
                </div>
              </div>
